const translations = {
  en: {
    ...
    searchHomes: {
      ...
      priceMax: "Max price",
      pool: "Pool",
      poolAny: "No preference",
      poolYes: "Must have pool",
      poolNo: "No pool",
      maxHoa: "Max HOA fee ($/month)",
  ...
  es: {
    ...
    searchHomes: {
      ...
      pool: "Piscina",
      poolAny: "Sin preferencia",
      poolYes: "Debe tener piscina",
      poolNo: "Sin piscina",
      maxHoa: "Cuota máxima de HOA ($/mes)",
      maxTax: "Impuesto anual máximo ($)",
      bedroomsMin: "Habitaciones (mín.)",
      bathroomsMin: "Baños (mín.)",
      stories: "Pisos",
      storiesAny: "Sin preferencia",
      sqftMin: "Pies² mínimos",
      sqftMax: "Pies² máximos",

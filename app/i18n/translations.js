const translations = {
  en: {
    ...
    propertyTax: {
      ...
      assessedValueTip: "The value the county property appraiser assigns to your property for tax purposes — not necessarily the same as market value. For existing homesteaded owners, Florida's Save Our Homes cap limits how fast it can rise each year.",
      nonAdValorem: "Non-ad valorem fees ($/yr)",
      nonAdValoremTip: "Flat fees for things like garbage collection, stormwater, or special district assessments — charged the same regardless of your property's value. \"Ad valorem\" (Latin for \"according to value\") means the opposite: a tax based on assessed value, like the property tax itself.",
  ...
  es: {
    ...
    propertyTax: {
      ...
      assessedValueTip: "El valor que el tasador de la propiedad del condado le asigna a su propiedad para fines fiscales — no necesariamente el mismo que el valor de mercado. Para propietarios existentes con exención de vivienda familiar, el límite de Save Our Homes de Florida limita qué tan rápido puede subir cada año.",
      nonAdValorem: "Cargos no ad valorem ($/año)",
      nonAdValoremTip: "Cargos fijos por cosas como recolección de basura, drenaje pluvial, o evaluaciones de distritos especiales — cobrados igual sin importar el valor de su propiedad. \"Ad valorem\" (latín para \"según el valor\") significa lo contrario: un impuesto basado en el valor catastral, como el impuesto sobre la propiedad en sí.",

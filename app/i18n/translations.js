const translations = {
  en: {
    ...
    searchHomes: {
      ...
      p: "Live MLS search is coming soon. In the meantime, set your criteria below and it goes straight to me — I'll email you back matching active listings, usually within a day.",
      ...
      poolNo: "No",
      maxHoa: "Max HOA fee",
      maxTax: "Max annual property tax",
      ...
      submit: "Send my search criteria",
      tourPromptText: "Want to go tour one of these in person?",
      tourPromptLink: "Send us a message",
      thankYouH1: "Got it — thank you.",
      thankYouP: "I've received your search criteria. Reach out any time if you'd like matching listings or want to tour a home in person.",
    },
  },
  es: {
    nav: {
    ...
    searchHomes: {
      ...
      p: "La búsqueda en vivo del MLS llega pronto. Mientras tanto, indique sus criterios abajo y me llegan directamente — le responderé por correo con propiedades activas que coincidan, generalmente en menos de un día.",
      ...
      poolYes: "Sí",
      poolNo: "No",
      maxHoa: "Cuota máxima de HOA",
      maxTax: "Impuesto anual máximo",
      ...
      submit: "Enviar mis criterios de búsqueda",
      tourPromptText: "¿Quiere ir a ver alguna en persona?",
      tourPromptLink: "Envíenos un mensaje",
      thankYouH1: "Recibido — gracias.",
      thankYouP: "He recibido sus criterios de búsqueda. Contácteme cuando quiera si desea propiedades que coincidan o quiere visitar una en persona.",
    },
  },
};

const translations = {
  en: {
    ...
    searchHomes: {
      ...
      contactHeading: "Where should I send matches?",
      submit: "Send my search criteria",
      thankYouH1: "Got it — thank you.",
      thankYouP: "I'll go through active listings that match your criteria and email you the best fits shortly.",
    },
  },
  es: {
    nav: {
    ...
    searchHomes: {
      ...
      contactHeading: "¿A dónde le envío las coincidencias?",
      submit: "Enviar mis criterios de búsqueda",
      thankYouH1: "Recibido — gracias.",
      thankYouP: "Revisaré las propiedades activas que coincidan con sus criterios y le enviaré las mejores opciones por correo en breve.",
    },
  },
};

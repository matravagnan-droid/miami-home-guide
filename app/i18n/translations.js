const translations = {
  en: {
    ...
    searchHomes: {
      ...
      any: "Any",
      noMax: "No max",
      mapLabel: "Browse the map",
      mapNote: "Updates with the city/area you pick below.",
  ...
  es: {
    ...
    searchHomes: {
      ...
      any: "Cualquiera",
      noMax: "Sin máximo",
      mapLabel: "Explorar el mapa",
      mapNote: "Se actualiza con la ciudad/área que elija abajo.",

...
export default function HomeClient({ articles }) {
  ...
  return (
    <>
      ...
      <section className="hero" style={{ backgroundImage: "linear-gradient(90deg, rgba(7,31,36,0.55) 0%, rgba(7,31,36,0.5) 32%, rgba(7,31,36,0) 62%), linear-gradient(180deg, rgba(7,31,36,0.55) 0%, rgba(16,63,69,0.4) 93%, var(--sand) 93%), url(/images/hero-skyline-panorama.jpg)" }}>

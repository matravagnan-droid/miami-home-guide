  ...
  return (
    <footer>
      ...
      <div className="eho-badge">
        <svg viewBox="0 0 100 132" fill="currentColor" role="img" aria-label="Equal Housing Opportunity">
          ...
          <text x="50" y="113" textAnchor="middle" fontSize="11" fontWeight="700" fontFamily="Arial, sans-serif" letterSpacing="0.3">EQUAL HOUSING</text>
          <text x="50" y="126" textAnchor="middle" fontSize="11" fontWeight="700" fontFamily="Arial, sans-serif" letterSpacing="0.3">OPPORTUNITY</text>
        </svg>
      </div>
    </footer>
  );
